/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: db22c0493e1b6d620110f1cb92bf5c41)
// Runtime types generated with workerd@1.20250507.0 2024-09-23 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		CORS_ORIGINS: "http://localhost:5173,https://chat-web-9h1.pages.dev";
